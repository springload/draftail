        ...
        return (
            <div className={`editor__controls${readOnly ? ' editor--readonly' : ''}`} role="toolbar">
                ...
                {options.ENTITY_TYPES.map(entity => (
                    <Button
                        key={entity.entity}
                        onClick={this.onRequestDialog.bind(this, entity.entity)}
                        label={entity.label}
                        icon={entity.icon}
                    />
                ))}
        ...
        return (
            ...
            >
                ...
                <Editor
                    ...
                    keyBindingFn={config.getKeyBindingFn(options.BLOCK_TYPES, options.INLINE_STYLES, options.ENTITY_TYPES)}
...
DraftailEditor.propTypes = {
    ...
    options: React.PropTypes.shape({
        ...
        ENTITY_TYPES: React.PropTypes.arrayOf(React.PropTypes.shape({
            entity: React.PropTypes.string.isRequired,
            label: React.PropTypes.string.isRequired,

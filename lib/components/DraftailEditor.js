...
class DraftailEditor extends Component {
    constructor(props) {
        ...
        this.onSourceComplete = this.onSourceComplete.bind(this);
    ...
    toggleSource(entityType, entityKey, entity) {
    ...
    renderSource() {
        ...
        if (sourceOptions && sourceOptions.entityConfig) {
            const Source = sourceOptions.entityConfig.source;

            return (
                <Source
                    onClose={this.onSourceComplete}
                    onUpdate={this.onSourceComplete}
                    entity={sourceOptions.entity}
                    entityKey={sourceOptions.entityKey}
                    editorState={editorState}
                    options={sourceOptions.entityConfig}
                />
            );
        }

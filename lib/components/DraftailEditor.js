...
class DraftailEditor extends Component {
    ...
    onChange(nextEditorState) {
        ...
        this.setState({
            ...
            this.updateTimeout = window.setTimeout(this.saveState, stateSaveInterval);
        });
    }
    ...
    render() {
        const { enableHorizontalRule, enableLineBreak, placeholder, stripPastedStyles, blockTypes, inlineStyles, entityTypes } = this.props;
        ...
        return (
            <div
                className={`editor${readOnly ? ' editor--readonly' : ''}${hidePlaceholder ? ' editor--hide-placeholder' : ''}${hasFocus ? ' editor--focus' : ''}`}

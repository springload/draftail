...
class DraftailEditor extends Component {
    ...
    renderTooltip() {
        ...
        return shouldShowTooltip && entityKey ? (
            <Portal
                onClose={this.toggleTooltip.bind(null, false)}
                closeOnResize
                closeOnType
            >
                <InlineTooltip
                    ...
                    onEdit={this.onEditEntity.bind(this, entityKey, blockKey)}
                    entityData={contentState.getEntity(entityKey).getData()}
                    target={this.tooltip.getBoundingClientRect()}
                />
            </Portal>
        ) : null;
    }

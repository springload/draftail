...
class DraftailEditor extends Component {
    constructor(props) {
        super(props);
        const { rawContentState, entityTypes, inlineStyles } = props;
        ...
        const customStyleMapParsed = DraftUtils.parseCustomStyleMap(
            INLINE_STYLE,
            CUSTOM_STYLE_MAP,
            inlineStyles,
        );
        ...
        this.state = {
            ...
            dialogOptions: null,
            entity: null,
            customStyleMap: customStyleMapParsed,
        };
    ...
    render() {
        ...
        const { editorState, hasFocus, readOnly, customStyleMap } = this.state;

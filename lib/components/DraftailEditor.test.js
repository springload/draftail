...
describe('DraftailEditor', () => {
    ...
    describe('onChange', () => {
        beforeEach(() => {
            jest
                .spyOn(normalize, 'filterPastedContent')
        ...
        it('no filter when typing', () => {
            ...
            expect(normalize.filterPastedContent).not.toHaveBeenCalled();
        });
        ...
        it('filter on paste', () => {
            ...
            expect(normalize.filterPastedContent).toHaveBeenCalled();
        });
    ...
    describe('tooltip', () => {
        describe('toggleTooltip', () => {
            it('on', () => {
                ...
                wrapper.instance().toggleTooltip(document.createElement('div'));
        ...
        describe('renderTooltip', () => {
            it('works', () => {
                ...
                wrapper.instance().toggleTooltip({
                    offsetHeight: 0,

...
export const KEYBOARD_SHORTCUTS = {
    ...
    [INLINE_STYLE.UNDERLINE]: { other: 'Ctrl + U', macOS: '⌘ + U' },
    [INLINE_STYLE.STRIKETHROUGH]: { other: 'Ctrl + ⇧ + X', macOS: '⌘ + ⇧ + X' },
    [INLINE_STYLE.SUPERSCRIPT]: { other: 'Ctrl + .', macOS: '⌘ + .' },
    [INLINE_STYLE.SUBSCRIPT]: { other: 'Ctrl + ,', macOS: '⌘ + ,' },

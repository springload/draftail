export default {
  ...
  blocks: [
    ...
    {
      key: "9mda0",
      text: "Block types: H1, H2, H3, H4, H5, H6, Blockquote, Code, UL, OL, P",
      type: "unordered-list-item",
      depth: 0,
      inlineStyleRanges: [],
      entityRanges: [],
    ...
    {
      key: "3haur",
      text: "Entities (things with data): Images, Embeds, Links, Documents",
      type: "unordered-list-item",
      depth: 0,
      inlineStyleRanges: [],
      entityRanges: [],
    ...
    {
      key: "ba5ve",
      text: "ReactDOM.render(editor, document.querySelector('[data-mount]'));",
      type: "code-block",
      depth: 0,
      inlineStyleRanges: [],
      entityRanges: [],
    ...
    {
      key: "9p5g8",
      text: "If you want to learn more about how we are using this, check out:",
      type: "unstyled",
      depth: 0,
      inlineStyleRanges: [],
      entityRanges: [],
